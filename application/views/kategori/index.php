                            ...
                            $no =1; 
                                foreach ($kategori as $user) {
                                    echo "<tr>
                                            ...
                                            <td>
                                            <div>
                                            <a href=".base_url('kategori/getedit/' . $user->id). " class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
                                            <a href=".base_url('kategori/delete/' . $user->id). " class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data kategori ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                            </div>
                                            </td>
                                    </tr>";
                                    $no++;
